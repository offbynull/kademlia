...
public class BucketTest {
    ...
    private static final Id BASE_ID = Id.createFromInteger(0x12340000L, 32);
    
    private static final Node NODE_0000 = new Node(Id.createFromInteger(0x12340000L, 32), "1");
    private static final Node NODE_0100 = new Node(Id.createFromInteger(0x12344000L, 32), "2");
    private static final Node NODE_1000 = new Node(Id.createFromInteger(0x12348000L, 32), "3");
    private static final Node NODE_1100 = new Node(Id.createFromInteger(0x1234C000L, 32), "4");
    private static final Node NODE_1111 = new Node(Id.createFromInteger(0x1234F000L, 32), "5");
