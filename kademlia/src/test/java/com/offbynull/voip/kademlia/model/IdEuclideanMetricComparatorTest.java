...
public class IdEuclideanMetricComparatorTest {
    ...
    private IdEuclideanMetricComparator fixture = new IdEuclideanMetricComparator(NODE_0000.getId()); // 0000
    ...
    @Test
    public void mustIdentifyByWhicheverIsLarger() {
    ...
    public void mustProperlySortLargeIdSpace() {
        ...
        fixture = new IdEuclideanMetricComparator(baseId);
        ...
        assertEquals(0x00L, list.get(0).getBitsAsLong(0, 4));
        assertEquals(0x04L, list.get(1).getBitsAsLong(0, 4));
        assertEquals(0x08L, list.get(2).getBitsAsLong(0, 4));
        assertEquals(0x0CL, list.get(3).getBitsAsLong(0, 4));
        assertEquals(0x0EL, list.get(4).getBitsAsLong(0, 4));
        assertEquals(0x0FL, list.get(5).getBitsAsLong(0, 4));
