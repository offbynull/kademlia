...
public class NodeActivitySetTest {
    ...
    @Test
    public void mustGetNodesThatAreIdle() throws Throwable {
        ActivityChangeSet res;
    ...
    @Test
    public void mustGetNodesThatAreNoLongerPending() throws Throwable {
        ActivityChangeSet res;
    ...
    @Test
    public void mustFailPendingNodeThatDoesntExist() throws Throwable {
        expectedException.expect(IllegalArgumentException.class);
        fixture.pending(NODE_010);
    }

    @Test
    public void mustFailIdlingNodeThatDoesntExist() throws Throwable {
        expectedException.expect(IllegalArgumentException.class);
        fixture.pending(NODE_010);
    }

    @Test
    public void mustFailPendingNodeIfAlreadyPending() throws Throwable {
        ActivityChangeSet res;
    ...
    @Test
    public void mustFailIdlingNodeIfAlreadyIdle() throws Throwable {
        ActivityChangeSet res;
    ...
    @Test
    public void mustPreventPendingNodeIfLinkDifferent() throws Throwable {
        ActivityChangeSet res;
        ...
        expectedException.expect(LinkConflictException.class);
        fixture.pending(new Node(NODE_001.getId(), "fakelink"));
    }

    @Test
    public void mustPreventIdlingNodeIfLinkDifferent() throws Throwable {
        ActivityChangeSet res;
        ...
        expectedException.expect(LinkConflictException.class);
        fixture.idle(new Node(NODE_001.getId(), "fakelink"));
    }
