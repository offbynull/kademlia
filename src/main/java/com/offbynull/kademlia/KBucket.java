...
//                                                                // own ID in it
     ...
     * <p>
     * If the node is marked as stale, but is touched ({@link #touch(java.time.Instant, com.offbynull.kademlia.Node) } before it
     ...
     * <p>
     * If the node is marked as locked, touching it ({@link #touch(java.time.Instant, com.offbynull.kademlia.Node) } has
     * no effect on it. It reverts back to normal state (unlocks) when {@link #unlock(com.offbynull.kademlia.Node) } is invoked.
     * <p>
